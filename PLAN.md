...
### [ ] T0.1 DesignTokens.swift の新設(定義のみ、移行はしない)
...
### [ ] T0.2 CompactToolbar を Toolbar.swift へ抽出
...
### [ ] T0.3 HistoryRail を HistoryRail.swift へ抽出
...
### [ ] T0.4 SettingsSheet・HelpPopover・WindowPickerSheet を Sheets.swift へ抽出
