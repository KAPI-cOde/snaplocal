...
### [ ] T9.6 エディタ下部の常設詳細面(OCR+メモ、Gyazo風) — スコープ確定済み(壁打ち 2026-06-12)
...
### [ ] T9.8 パネルの最前面ピン留め設定+ピンインジケータ(ユーザーFB 2026-06-12、壁打ちで確定)
...
### [ ] T9.9 キャプチャ時のソースURL記録 — ブックマーク的活用(ユーザー要望 2026-06-12、壁打ちで確定)
